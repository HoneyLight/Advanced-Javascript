...
// the '.toString' added to the date method will make it select the year, month and date for you.
    ...
    // to post / create a user on the api, you use the post method and also ensure to add headers cos it's a way of telling the api the kind of content you are sending to it then you also add the body which will carry the user input data. 
